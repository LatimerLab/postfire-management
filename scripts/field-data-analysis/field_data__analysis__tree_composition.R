...
# Diagnostic plots
pines.m1.res <- resid(pines.m1)[,1]
pines.m1.fitted <- fitted(pines.m1)[,1]
qqnorm(pines.m1.res) # underfitted 
plot(pines.m1.res ~ pines.m1.fitted) 
plot(pines.m1.fitted ~ plot_dhm_pine_std$prop_response) # not awesome, not terrible 
